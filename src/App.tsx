...
import { Settings, Activity, BookOpen, CheckCircle2 } from 'lucide-react';
import '../index.css'; // WICHTIG: Damit Tailwind geladen wird
    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 p-4 md:p-8 font-sans">
      <div className="max-w-6xl mx-auto">
        <header className="mb-8 border-b border-slate-800 pb-6">
          <h1 className="text-3xl font-black text-sky-400 tracking-tight text-center md:text-left">SINUS-LERNAPP</h1>
        </header>
        <Tabs.Root defaultValue="learn">
          ...
          <Tabs.Content value="learn" className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-slate-900/80 p-4 rounded-xl border border-slate-800 text-center">
                    <p className="text-[10px] text-slate-500 uppercase font-bold">T</p>
            ...
            <aside className="bg-slate-900/30 p-6 rounded-2xl border border-slate-800">
              ...
              <Accordion.Root type="single" collapsible className="space-y-3">
                <Accordion.Item value="1" className="bg-slate-950 border border-slate-800 rounded-lg">
                  <Accordion.Trigger className="w-full p-3 text-left text-sm font-semibold">Effektivwert</Accordion.Trigger>
                  <Accordion.Content className="p-3 text-xs text-slate-400">U_eff = Û / √2</Accordion.Content>
                </Accordion.Item>
              </Accordion.Root>
            </aside>
          </Tabs.Content>
